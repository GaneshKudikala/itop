...
/**
 * Classes and menus for itop-problem-mgmt (version 2.5.0)
 *
...
class MenuCreation_itop_problem_mgmt extends ModuleHandlerAPI
{
	public static function OnMenuCreation()
	{
		...
		$__comp_menus__['ProblemManagement'] = new MenuGroup('ProblemManagement', 42 , null, UR_ACTION_MODIFY, UR_ALLOWED_YES, null);
		$__comp_menus__['Problem:Overview'] = new DashboardMenuNode('Problem:Overview', dirname(__FILE__).'/problem_overview_dashboard_menu.xml', $__comp_menus__['ProblemManagement']->GetIndex(), 0 , null, UR_ACTION_MODIFY, UR_ALLOWED_YES, null);
