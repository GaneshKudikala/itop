...
/**
 * Classes and menus for itop-change-mgmt-itil (version 2.5.0)
 *
...
abstract class Change extends Ticket
{
	public static function Init()
	{
		...
		MetaModel::Init_DefineHighlightScale( array(
		    'approved' => array('rank' => 1, 'color' => HILIGHT_CLASS_NONE, 'icon' => utils::GetAbsoluteUrlModulesRoot().'itop-change-mgmt-itil/images/change-approved.png'),
		    'rejected' => array('rank' => 2, 'color' => HILIGHT_CLASS_NONE, 'icon' => utils::GetAbsoluteUrlModulesRoot().'itop-change-mgmt-itil/images/change-rejected.png'),
		    'closed' => array('rank' => 3, 'color' => HILIGHT_CLASS_NONE, 'icon' => utils::GetAbsoluteUrlModulesRoot().'itop-change-mgmt-itil/images/change-closed.png'),
		));
