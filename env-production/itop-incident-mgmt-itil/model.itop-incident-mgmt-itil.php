...
/**
 * Classes and menus for itop-incident-mgmt-itil (version 2.5.0)
 *
...
class MenuCreation_itop_incident_mgmt_itil extends ModuleHandlerAPI
{
	public static function OnMenuCreation()
	{
		...
		$__comp_menus__['IncidentManagement'] = new MenuGroup('IncidentManagement', 35 , null, UR_ACTION_MODIFY, UR_ALLOWED_YES, null);
		$__comp_menus__['Incident:Overview'] = new DashboardMenuNode('Incident:Overview', dirname(__FILE__).'/incident_overview_dashboard_menu.xml', $__comp_menus__['IncidentManagement']->GetIndex(), 0 , null, UR_ACTION_MODIFY, UR_ALLOWED_YES, null);
