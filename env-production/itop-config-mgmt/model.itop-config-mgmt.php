...
/**
 * Classes and menus for itop-config-mgmt (version 2.5.0)
 *
...
class Person extends Contact
{
	public static function Init()
	{
		...
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeImage("picture", array("is_null_allowed"=>true, "depends_on"=>array(), "display_max_width"=>96, "display_max_height"=>96, "storage_max_width"=>128, "storage_max_height"=>128, "default_image"=>utils::GetAbsoluteUrlModulesRoot().'itop-config-mgmt/images/silhouette.png', "always_load_in_tables"=>false)));
