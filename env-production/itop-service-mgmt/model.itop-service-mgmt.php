...
/**
 * Classes and menus for itop-service-mgmt (version 2.5.0)
 *
...
class MenuCreation_itop_service_mgmt extends ModuleHandlerAPI
{
	public static function OnMenuCreation()
	{
		...
		$__comp_menus__['Service:Overview'] = new DashboardMenuNode('Service:Overview', dirname(__FILE__).'/service_overview_dashboard_menu.xml', $__comp_menus__['ServiceManagement']->GetIndex(), 0 , null, UR_ACTION_MODIFY, UR_ALLOWED_YES, null);
