...
/**
 * Classes and menus for itop-request-mgmt-itil (version 2.5.0)
 *
...
class MenuCreation_itop_request_mgmt_itil extends ModuleHandlerAPI
{
	public static function OnMenuCreation()
	{
		...
		$__comp_menus__['RequestManagement'] = new MenuGroup('RequestManagement', 30 , null, UR_ACTION_MODIFY, UR_ALLOWED_YES, null);
		$__comp_menus__['UserRequest:Overview'] = new DashboardMenuNode('UserRequest:Overview', dirname(__FILE__).'/userrequest_overview_dashboard_menu.xml', $__comp_menus__['RequestManagement']->GetIndex(), 0 , null, UR_ACTION_MODIFY, UR_ALLOWED_YES, null);
