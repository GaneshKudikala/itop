...
class __TwigTemplate_04b737c4277c6cdf778f791f8baf2b3bcdf58b457d4dfcc808514c36f8e9a349 extends Twig_Template
{
...
\t\t\t\t\t\t\t\t\t";
            ...
            // line 126
            echo "\t\t\t\t\t\t\t\t\t\t";
            echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('dict_s')->getCallable(), array("Brick:Portal:UserProfile:Password:CantChangeContactAdministrator")), "html", null, true);
            echo "
\t\t\t\t\t\t\t\t\t";
        }
        // line 128
...
";
    ...
    {
        return new Twig_Source("", "itop-portal-base/portal/src/views/bricks/user-profile/layout.html.twig", "/var/www/html/env-production/env-production/itop-portal-base/portal/src/views/bricks/user-profile/layout.html.twig");
    }
}
